...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="article-wrapper" data-v-526dd66a><article class="article-container" data-v-526dd66a><header class="article-header" data-v-526dd66a><h1 class="article-title" data-v-526dd66a>${ssrInterpolate(post.value.title)}</h1></header><section class="article-content" data-v-526dd66a><!--[-->`);
      ssrRenderList(post.value.description, (paragraph, i) => {
        _push(`<p class="article-paragraph" data-v-526dd66a>${ssrInterpolate(paragraph)}</p>`);
      });
      _push(`<!--]--></section></article></div><section class="container" data-v-526dd66a><div class="opp-grid" data-v-526dd66a><!--[-->`);
      ssrRenderList(opportunities.value, (opp) => {
        _push(`<div class="card" data-v-526dd66a><div class="card-img" data-v-526dd66a><span class="card-badge" data-v-526dd66a>${ssrInterpolate(opp.category || "Opportunity")}</span><img${ssrRenderAttr("src", _imports_0)} data-v-526dd66a></div><div class="card-content" data-v-526dd66a><h3 class="label" data-v-526dd66a>${ssrInterpolate(opp.title)}</h3><p data-v-526dd66a>${ssrInterpolate(truncate(opp.description[0] || "", 100))}</p><div class="card-footer" data-v-526dd66a><span class="deadline" data-v-526dd66a>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/opportunities/scholarships/[slug].vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const _slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-526dd66a"]]);

export { _slug_ as default };
//# sourceMappingURL=_slug_-CjRndEn8.mjs.map
