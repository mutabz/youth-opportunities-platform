...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "194abb24-f6a1-4fe1-a097-cea4884fa8c3",
  ...
  "public": {
    "baseURL": "http://oppoxx.pythonanywhere.com/api",
    "nuxt-robots": {
      "version": "5.7.1",
      ...
      "sitemap": [
        "https://youthplatform.co.rw/sitemap.xml",
        "/sitemap.xml"
      ],
      "header": true,
...
const _ggu4tivo3K0XQj6a3C_8yCnixmjjjjBTuCvZQYNsZA8 = defineNitroPlugin(async (nitroApp) => {
...
const _Ch7y1jPrj8IFRIzBxKYXEGKUwClai7bB4VU81vcmQLo = defineNitroPlugin(async (nitroApp) => {
...
const plugins = [
  _ggu4tivo3K0XQj6a3C_8yCnixmjjjjBTuCvZQYNsZA8,
_Ch7y1jPrj8IFRIzBxKYXEGKUwClai7bB4VU81vcmQLo
];
...
const collections = {
  'fa6-solid': () => require$1('@iconify-json/fa6-solid/icons.json'),
};

const DEFAULT_ENDPOINT = "https://api.iconify.design";
const _f0qycf = defineCachedEventHandler(async (event) => {
...
const _fboC8i = eventHandler(async (e) => {
...
const _LVprRD = defineEventHandler(async (e) => {
...
const _R6ea9q = defineEventHandler(async (e) => {
...
const _W7oLi4 = defineEventHandler(async (e) => {
  const nitroApp = useNitroApp();
...
const _lbv0el = defineEventHandler(async (e) => {
...
const _lazy_aqggMN = () => import('../routes/api/sitemap-opportunities.mjs');
const _lazy__7d0nW = () => import('../routes/api/sitemap-organizations.mjs');
const _lazy_oiGlcJ = () => import('../routes/api/sitemap-resources.mjs');
const _lazy_c5x59Q = () => import('../routes/api/sitemap-static.mjs');
const _lazy_vOBpFT = () => import('../routes/api/sitemap-urls.mjs');
const _lazy_2s4oZX = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/sitemap-opportunities', handler: _lazy_aqggMN, lazy: true, middleware: false, method: undefined },
  { route: '/api/sitemap-organizations', handler: _lazy__7d0nW, lazy: true, middleware: false, method: undefined },
  { route: '/api/sitemap-resources', handler: _lazy_oiGlcJ, lazy: true, middleware: false, method: undefined },
  { route: '/api/sitemap-static', handler: _lazy_c5x59Q, lazy: true, middleware: false, method: undefined },
  { route: '/api/sitemap-urls', handler: _lazy_vOBpFT, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_2s4oZX, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/api/_nuxt_icon/:collection', handler: _f0qycf, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _fboC8i, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _LVprRD, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _R6ea9q, lazy: false, middleware: false, method: undefined },
  { route: '/robots.txt', handler: _W7oLi4, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _lbv0el, lazy: false, middleware: true, method: undefined },
  { route: '/sitemap.xml/_payload.json', handler: _lazy_2s4oZX, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_2s4oZX, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch$1 as $, setCookie as A, getCookie as B, deleteCookie as C, baseURL as D, defu as E, createHooks as F, executeAsync as G, parseQuery as H, withTrailingSlash as I, withoutTrailingSlash as J, listener as K, getResponseStatus as a, buildAssetsURL as b, defineRenderHandler as c, defineEventHandler as d, getQuery as e, createError$1 as f, getResponseStatusText as g, getRouteRules as h, useNitroApp as i, joinURL as j, parseURL as k, encodePath as l, decodePath as m, klona as n, hasProtocol as o, publicAssetsURL as p, isScriptProtocol as q, defuFn as r, sanitizeStatusCode as s, getContext as t, useRuntimeConfig as u, parse as v, withQuery as w, getRequestHeader as x, destr as y, isEqual as z };
